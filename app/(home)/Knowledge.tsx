...
const Knowledge = memo(({ sheet, children }: KnowledgeProps) => {
    ...
    let dWidth: number = 0;
    let canvasID: string = "patchy-main";
    ...
    useEffect(() => {
        // first load
        if (!patchyLoaded) {
            if (document.getElementById("patchy-main") != null) { return; }
            // create canvas with <canvas width="1700" height="500" id="patchy-main" className="fixed" />
            const tempCanvas = document.createElement('canvas');
            tempCanvas.width = window.innerWidth;
            tempCanvas.height = window.innerHeight;
            tempCanvas.id = "patchy-main";
    ...
    chars = [
        new Patchouli(patchySheet, dWidth + 200, dHeight, Animations1.GettingUp, 0, Animations1, Direction.Right, canvas),
    ];
