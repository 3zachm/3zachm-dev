...
async function applyCache(key: string, query: string, gql: boolean, cacheTime: number) {
...
async function getChannelEmotes(channelID: string) {
    ...
    return await applyCache("7TV.CHANNEL_EMOTES_" + channelID, gqlQuery, true, 1200);
}
