...
function Navbar({ options }: NavProps) {
    ...
    return (
        <div className="p-5 font-Manrope text-2xl flex items-center absolute z-[100] shadow-lg backdrop-blur bg-opacity-70 bg-zinc-900 w-screen pointer-events-none">
