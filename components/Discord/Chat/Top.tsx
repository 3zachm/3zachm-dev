function Top() {
    return (
        <div className="top w-[84vw] h-12 dark:bg-[#36393f] border-b border-[#2b2d32]">
            <section className="flex justify-between relative items-center min-w-0 w-full h-12 text-[16px] cursor-default z-[2] text-[#dcddde]" style={{ lineHeight: "20px" }} aria-label="Channel header">
                <div className="relative flex min-w-0 items-center overflow-hidden">
                    <div className="relative h-6 w-auto ml-4 mr-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" className="w-6 h-6 text-[#72767d]" x="0" y="0" aria-hidden="true">
                    ...
                    {/* <span class="hiddenVisually-2ydA7k">Text Channel</span> */}
                    <h3 className="flex justify-start overflow-hidden whitespace-nowrap font-bold text-white">testing</h3>
                </div>
                <div className="min-w-0 flex">
                    <div className="relative h-6 flex ml-2 mr-2" role="button" aria-label="Threads" tabIndex={0}>
                        <svg x="0" y="0" className="w-6 h-6 text-[#72767d]" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="relative h-6 flex ml-2 mr-2" role="button" aria-label="Notification Settings" tabIndex={0}>
                        <svg x="0" y="0" className="w-6 h-6 text-[#72767d]" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="relative h-6 flex ml-2 mr-2" role="button" aria-label="Pinned Messages" tabIndex={0}>
                        <svg x="0" y="0" className="w-6 h-6 text-[#72767d]" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <div className="relative h-6 flex ml-2 mr-2" role="button" aria-label="Hide Member List" tabIndex={0}>
                        <svg x="0" y="0" className="w-6 h-6 text-[#72767d]" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    {/* <div class="search-39IXmY">
                        <div class="search-2Mwzzq">
                            <div class="searchBar-jGtisZ">
                                <div class="DraftEditor-root">
                                    <div class="public-DraftEditorPlaceholder-root">
                                        <div class="public-DraftEditorPlaceholder-inner" id="placeholder-57ba0" style="white-space: pre-wrap;">Search</div>
                                    </div>
                                    <div class="DraftEditor-editorContainer">
                                        <div aria-describedby="placeholder-57ba0" aria-expanded="false" aria-label="Search" class="notranslate public-DraftEditor-content" contenteditable="true" role="combobox" spellcheck="false" aria-haspopup="listbox" style="outline: none; user-select: text; white-space: pre-wrap; overflow-wrap: break-word;">
                                            <div data-contents="true">
                                                <div class="" data-block="true" data-editor="57ba0" data-offset-key="c7i0t-0-0">
                                                    <div data-offset-key="c7i0t-0-0" class="public-DraftStyleDefault-block public-DraftStyleDefault-ltr">
                                                        <span data-offset-key="c7i0t-0-0">
                                                            <br data-text="true">
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                <div class="icon-tZMHgY iconLayout-SqV3nb small-1hw8IT" tabindex="-1" aria-hidden="true" aria-label="Clear search" role="button">
                                    <div class="iconContainer-1RqWJj">
                                        <svg className="w-6 h-6 text-[#72767d]" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
                                        ...
                                        <svg class="icon-18rqoe" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <div className="relative h-6 flex ml-2 mr-2" role="button" aria-label="Inbox" tabIndex={0}>
                        <svg x="0" y="0" className="w-6 h-6 text-[#72767d]" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <a href="https://patchouli.rocks" rel="noreferrer noopener" target="_blank">
                        <div className="relative h-6 flex ml-2 mr-2" role="button" aria-label="Help" tabIndex={0}>
                            <svg x="0" y="0" className="w-6 h-6 text-[#72767d]" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
